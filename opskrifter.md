...
<div class="recipe-grid">
  ...
  {% for opskrift in seneste limit: 4 %}
    <div class="recipe-item {% if forloop.index == 4 %}hide-on-desktop{% endif %}">
...
<style>
  ...
  .recipe-img-container { 
    width: 100%; aspect-ratio: 4 / 3; position: relative; overflow: hidden; background: #f9f9f9; 
  }
  ...
  .see-more-container { text-align: right; margin-top: 25px; }
  .see-more-link { color: #000; text-decoration: none; font-size: 0.9em; font-weight: 600; border-bottom: 1px solid transparent; transition: border 0.2s; }
  .see-more-link:hover { border-bottom: 1px solid #000; }
</style>
